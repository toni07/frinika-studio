...
public class CreateTriggerSoundTrackAction extends AbstractAction {
    ...
    public CreateTriggerSoundTrackAction(ProjectFrame project) {
        super(getMessage("sequencer.project.add_trigger_sound_track"));
        this.project = project;
    }

    @Override
    public void actionPerformed(ActionEvent arg0) {
        project.getProjectContainer().getEditHistoryContainer().mark(getMessage("sequencer.project.add_trigger_sound_track"));
        project.getProjectContainer().createTriggerSoundTrack();
